        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="absolute -inset-3 bg-gradient-to-r from-primary via-secondary to-primary-light rounded-2xl blur-xl opacity-30 group-hover:opacity-40 transition duration-1000 animate-pulse-slow"></div>
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden border border-primary/20 transition-all duration-500 hover:shadow-primary/20 hover:shadow-lg">
                <div className="flex flex-col h-[700px] relative">
                  {/* Enhanced badge */}
                  <div className="absolute -top-6 right-6 bg-gradient-to-r from-primary to-primary-dark text-white px-4 py-1.5 rounded-t-lg text-sm font-medium z-20 flex items-center shadow-lg animate-pulse-slow">
