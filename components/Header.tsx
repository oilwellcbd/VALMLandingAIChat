            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-6">
                ...
                <a href="tel:(866) 216-3577" className="text-sm flex items-center hover:text-primary transition-colors group">
                  <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center mr-2 group-hover:bg-primary/40 transition-all duration-300">
                ...
                <a href="mailto:info@valoansfinance.com" className="text-sm flex items-center hover:text-primary transition-colors group">
                  <div className="w-8 h-8 rounded-full bg-secondary/20 flex items-center justify-center mr-2 group-hover:bg-secondary/40 transition-all duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="text-sm flex items-center group">
                  <div className="w-8 h-8 rounded-full bg-primary-dark/20 flex items-center justify-center mr-2 group-hover:bg-primary-dark/40 transition-all duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div>
                    <span className="text-xs text-gray-400 block">Business Hours</span>
              ...
              <div className="flex items-center space-x-3">
                <a href="#" className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center group hover:bg-[#1877F2] transition-all duration-300 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="w-4 h-4 text-white relative z-10">
                    <path fill="currentColor" d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/>
                  </svg>
                </a>
                <a href="#" className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center group hover:bg-[#1DA1F2] transition-all duration-300 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 text-white relative z-10">
                ...
                <a href="#" className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center group hover:bg-[#0A66C2] transition-all duration-300 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-4 h-4 text-white relative z-10">
                    <path fill="currentColor" d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"/>
                  </svg>
                </a>
                <a href="#" className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center group hover:bg-[#E4405F] transition-all duration-300 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-4 h-4 text-white relative z-10">
                ...
                <a href="#" className="w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center group hover:bg-[#FF0000] transition-all duration-300 shadow-md">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="w-4 h-4 text-white relative z-10">
